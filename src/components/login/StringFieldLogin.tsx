...
const StringFieldLogin = forwardRef(
  ({ type, label, ...field }: Props, ref: any) => {
    return (
      <div className="border-2 h-14 border-field-border rounded-lg bg-field-background relative w-full z-0">
        <label
        ...
        <input
          autoComplete="off"
          ref={ref}
          className="bg-field-background absolute right-28 top-0 outline-none w-60 h-full text-sm "
          type={type}
          {...field}
        />
      </div>
